...
export default function OverviewView({ showToast }) {
  ...
  const userColumns = [
    ...
    { key: 'updated_at', label: 'Last Updated', width: "10%", render: (u) => u.updated_at ? new Date(u.updated_at).toLocaleString('en-US', { month: 'numeric', day: 'numeric', year: 'numeric', hour: 'numeric', minute: '2-digit' }).replace(',', '') : '—' },
    {
      key: "actions",
      label: "Actions",
      width: "25%",
